...
input_para = {
    # 数据抽取参数
    'train_pic_path' : r'C:\Users\Yauno\Downloads\rsna-bone-age\boneage-training-dataset', # 原图像路径
    'train_csv_path' : r'C:\Users\Yauno\Downloads\rsna-bone-age\boneage-training-dataset.csv', # csv数据
    'train_output' : r'C:\Study\test\kaggle-bonage\train-male', # 图片, '\labels.txt'
    ...
    # 数据扩充参数
    # male
    'augumentation_output' : r'C:\Study\test\kaggle-bonage\male_augument', # 扩充图像输出路径
    'augumentation_label_output' : r'C:\Study\test\kaggle-bonage\male_augument', # '\labels.txt'
    ...
    # k-fold 划分训练集
    # male
    'split_output' : r'C:\Study\test\kaggle-bonage\train-male_disposal_out', # K-fold输出路径
    'k_fold' : 5, # default 5
    # female 
    'fesplit_output' : r'C:\Study\test\kaggle-bonage\train-female_disposal_out', 
    'fek_fold' : 5, # default 5


    # data convert
    # male
    'tfrecord_output' :  r'C:\Study\test\kaggle-bonage\male_tf_record', # tfrecord输出路径
    'fetfrecord_output' :  r'C:\Study\test\kaggle-bonage\male_tf_record',
...
if __name__ == '__main__':
    ...
    # 数据划分
    label_path = os.path.join(input_para['augumentation_output'], 'labels.txt')
    input_dir = input_para['augumentation_output']
    output_dir = input_para['split_output']
    k_fold = input_para['k_fold']
    ...
    # 数据格式转换
    # male
    train_data = input_para['split_output']
    ...
    test_data = input_para['test_output']
    label_path = os.path.join(input_para['labels_output'], 'labels.txt') # 使用训练集的标签
    model_list = []
