...
plt.subplot(122), plt.imshow(cv2.cvtColor(cv2.imread('image/m_4.jpg'), cv2.COLOR_BGR2RGB))
...
# 通过 morphologyEx()变换之后对图像进行膨胀操作, 可以得到大部分都是北京的区域
